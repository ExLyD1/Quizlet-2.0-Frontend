<template>
    <div class="w-full max-w-md rounded-3xl bg-brand-dark p-8">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="flex shrink-0 items-center gap-1">
                    ...
                    <button type="button" @click="showPassword = !showPassword">
                        <Eye v-if="!showPassword" class="size-4 text-brand-muted hover:text-brand-pale transition-colors" />
                        <EyeOff v-else class="size-4 text-brand-muted hover:text-brand-pale transition-colors" />
                    </button>
                </div>
            </div>
        </div>
        ...
        <!-- Submit button -->
        <UiButton variant="light" class="mt-6 w-full rounded-xl py-4 text-body font-bold">
